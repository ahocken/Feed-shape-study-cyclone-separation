...
Hocken, A., Plata, D.L., Olsen, B.D. Exploration of feed shape, size, infill, and aspect ratio on cyclone separation process for small-format plastics
...
RoundWireScrew_v4.step

STL files for 3D printed feed materials

Files for running batch force calculations in Ansys Fluent:

ForceCalc_Journal.jou
ForceCalcsBatchScript.py
